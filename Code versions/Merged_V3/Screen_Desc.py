...
# Alias for starting capture
def start_capture():
    return capture_and_describe_once()

if __name__ == "__main__":
    select_monitor_popup()
    capture_and_describe_once()  # Run the screen capture and description process once
